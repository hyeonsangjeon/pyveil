...
uv run --isolated --with ./dist/pyveil-0.1.1-py3-none-any.whl python -c "from pyveil import Veil; assert '[EMAIL:' in Veil.high(secret=b'test').redact_text('alice@example.com').text"
```
